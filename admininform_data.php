<?php
    ...
    if($_GET["action"]=="getForm"){
        ...
        echo "</div>";
        echo " <form action='admininform_data.php?action=saveData' method='post' target='upload_target' onsubmit='clickupload();' >";
    ...
    if($_GET["action"]=="getFormUpload"){
        ...
        echo "<div class='box-body'>";
            ...
            echo "</div>";
            echo " <form id='frmDoc' action='admininform_data.php?action=insertDoc' enctype='multipart/form-data' method='post' target='upload_target' onsubmit='clickuploadDoc();' >";
                echo "<div class='form-group'>";
