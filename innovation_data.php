		...
		while($row=mysql_fetch_array($result)){
			...
			@$rowc=mysql_fetch_array($resultc);
                    ...
                    <div class="media services-wrap wow fadeInDown">
                        <div class="pull-left">
                            <img class="img-responsive" src="user/profile_pic/'.$row[4].'" width="150">
                        </div>
                        <div class="media-body">
                        <a href="#'.$row[0].'" title="แก้ไขข้อมูล" class="showinno">
                            <h3 class="media-heading">'.$row[1].'<font color="red"> ('.$rowc[0].')</font></h3></a>    
						เจ้าของผลงาน
...
';
		...
		echo '      </div>
			<button type="button" id="bnback" class="btn btn-default">ผลงานทั้งหมด</button>
		';
        echo '
                </div>
		';
