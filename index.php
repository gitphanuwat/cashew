...
<body class="homepage">
    ...
    <section id="feature" class="transparent-bg">
        <div class="container">
			...
			?>
                            <h2>ผลิตภัณฑ์(<?php echo $row1[0];?>)</h2>
			...
			?>
                            ...
                            <h3>ข้อมูลเกษตรกร และพื้นที่การผลิตในกลุ่มเกษตรกร</h3>
                        </div>
                    </div><!--/.col-md-4-->
			...
			?>
                            ...
                            <h3>ระบบจัดการข้อมูลความรู้ โครงการ และกิจกรรมที่เสริมสร้างความเข้มแข็ง</h3>
                        </div>
                    </div><!--/.col-md-4-->
